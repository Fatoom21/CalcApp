package com.faa.calcapp.ui.input;
...
import com.faa.calcapp.R;
import com.faa.calcapp.ui.output.OutputScreen;
...
public class InputScreen extends AppCompatActivity {
    ...
    TextView addResult_txt ,subResult_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (number1.isEmpty() || number2.isEmpty()){
                    ...
                    subResult_txt.setText(value+"");
                    subResult_txt.setVisibility(View.VISIBLE);
                    if (num1 < num2)
                        Toast.makeText(InputScreen.this, "the result is negative " + value, Toast.LENGTH_LONG).show();
                    else
                        subResult_txt.setText(value+"");
                  ...
                  if(value==0) {
                      subResult_txt.setText(value + "");
                      subResult_txt.setVisibility(View.VISIBLE);
                      Toast.makeText(InputScreen.this, "the result is zero " + value, Toast.LENGTH_LONG).show();
                  }
        ...
        clear_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                subResult_txt.setText("");
                subResult_txt.setVisibility(View.GONE);
    ...
    public void initViews() {
        ...
        subResult_txt =findViewById(R.id.txt_subResult);
    }
